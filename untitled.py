...
class Ui_sideBar(object):
    ...
    def retranslateUi(self, sideBar):
        ...
        sideBar.setWindowTitle(_translate("sideBar", "MainWindow"))
        self.userNameLabel.setText(_translate("sideBar", "TextLabel"))
        self.logoutButton.setText(_translate("sideBar", "LogOut"))
